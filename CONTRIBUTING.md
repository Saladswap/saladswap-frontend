# Contributing to the Salad ecosystem 🥞

Thanks for taking the time to contribute !
You can start by reading our [Contribution guidelines](https://docs.saladswap.finance/code/contributing) first.
...
```
TranslateString(675, `You have ${saladBalance} left in your wallet`, { num: saladBalance })
```
