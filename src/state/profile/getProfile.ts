...
import { getProfileContract, getSaladRabbitContract } from 'utils/contractHelpers'
...
const rabbitContract = getSaladRabbitContract()
  ...
  try {
    ...
    if (isActive) {
      ...
      Cookies.set(
        ...
        {
          username,
          avatar: `https://saladswap.finance/images/nfts/${nft.images.sm}`,
        },
        { domain: 'saladswap.finance', secure: true, expires: 30 },
      )
    }
