...
import { LinkExternal, Text, Link } from '@saladswap/uikit'
...
const ActionPanel: React.FunctionComponent<ActionPanelProps> = ({ details, apr, multiplier, liquidity }) => {
  ...
  const info = `https://saladswap.info/pair/${lpAddress}`
  ...
  return (
    <Container>
      <InfoContainer>
        <StakeContainer>
          Stake:
          <StyledLinkExternal href={`https://exchange.saladswap.finance/#/add/${liquidityUrlPathParts}`}>
            {lpLabel}
          </StyledLinkExternal>
        </StakeContainer>
