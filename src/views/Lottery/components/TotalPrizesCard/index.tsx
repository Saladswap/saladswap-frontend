...
import { Heading, Card, CardBody, CardFooter, Text, SaladRoundIcon, Flex, Skeleton } from '@saladswap/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} SALAD</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
