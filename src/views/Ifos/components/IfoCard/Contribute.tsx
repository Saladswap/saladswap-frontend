...
import { Box, Button, Flex, Text, useModal } from '@saladswap/uikit'
...
const Contribute: React.FC<ContributeProps> = ({
  ...
  const handleContributeSuccess = (amount: BigNumber) => {
    toastSuccess('Success!', `You have contributed ${getBalanceNumber(amount)} SALAD-BNB LP tokens to this IFO!`)
