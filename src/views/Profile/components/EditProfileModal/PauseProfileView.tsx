...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@saladswap/uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  const { numberSaladToReactivate } = useGetProfileCosts()
  const TranslateString = useI18n()
  const saladProfileContract = useProfileContract()
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {TranslateString(999, `Cost to reactivate in future: ${getBalanceNumber(numberSaladToReactivate)} SALAD`)}
      </Text>
