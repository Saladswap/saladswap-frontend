...
import { InjectedModalProps, Modal } from '@saladswap/uikit'
import useI18n from 'hooks/useI18n'
import useEditProfile, { Views } from './reducer'
import StartView from './StartView'
import PauseProfileView from './PauseProfileView'
import ChangeProfilePicView from './ChangeProfilePicView'
import ApproveSaladView from './ApproveSaladView'
...
const viewTitle = {
  ...
  [Views.APPROVE]: { id: 999, label: 'Approve SALAD' },
}
  ...
  return (
    <Modal title={TranslateString(id, label)} onBack={handleBack} onDismiss={onDismiss} hideCloseButton={!isStartView}>
      <div style={{ maxWidth: '400px' }}>
        ...
        {currentView === Views.APPROVE && <ApproveSaladView goToChange={goToChange} onDismiss={onDismiss} />}
      </div>
    </Modal>
  )
}
