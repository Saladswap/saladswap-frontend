...
import { Heading, Text, Flex, ChevronRightIcon } from '@saladswap/uikit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'Salad Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'Salad Collectibles are special ERC-721 NFTs that can be used on the SaladSwap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved Salad Collectibles won't be shown here.",
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{TranslateString(999, 'See all approved Salad Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
