...
import { Button, Flex, Heading, useModal, Won } from '@saladswap/uikit'
import { useProfile } from 'state/hooks'
import useI18n from 'hooks/useI18n'
import ClaimNftAndSaladModal, { useCanClaim } from './ClaimGiftModal'
...
const ProfileHeader = () => {
  ...
  const [onPresentClaimGiftModal] = useModal(<ClaimNftAndSaladModal onSuccess={checkClaimStatus} />)
